...
# === INTEGRAZIONE BACKUP (fase 3.3 Export) ===
from main_backup_v2 import perform_backup
...
class MainScreen(Screen):
    ...
    def export_data(self):
        """Avvia esportazione proporzionata e centrata"""
        try:
            ...
            log_error(err)
            notify_error(err)
            self.status_lbl.text = "Errore: export"
            self.status_lbl.color = (1, 0, 0, 1)
...
class BlackjackApp(App):
    def build(self):
        notify_success("Applicazione Blackjack AI Genius V3 Export avviata ✅")
        return RootUI()
