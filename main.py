...
class MainScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.status_lbl = Label(text="Stato: pronto", color=(0, 1, 0, 1),
                                font_size="18sp", halign="center", valign="middle", bold=True)
        ...
        # PULSANTI PRINCIPALI
        actions = [("Consiglia mossa", self.consiglia_mossa),
        ...
        self.output_lbl = Label(text="", color=CURRENT_THEME["fg"], font_size="16sp",
        ...
        # MENU LATERALE
        self.menu_layout = ColoredBoxLayout(orientation='vertical', size_hint=(None, 1),
                                            width=dp(250), pos_hint={'x': -1, 'y': 0},
        ...
        # Mostra popup consenso all'avvio
